import discord, asyncio, sqlite3, sys, linecache
            ...
            while True:
                try:
                    ...
                    if 'https://steamcommunity.com/id/' in message.content or 'https://steamcommunity.com/profiles/' in message.content and message.author in users_signing:
                        ...
                        await message.delete()
                        if message.author in users_signing: await message.channel.send("Not a valid steam profile link, link should include either 'https://steamcommunity.com/id/' or 'https://steamcommunity.com/profiles/'", delete_after=4)
                except Exception as e:
                    print(e)
                    await interaction.channel.send("**Signup timed out! deleting channel...**")
                    if self.signup_user in users_signing: del users_signing[self.signup_user]
            ...
            while True:
                try:
                    ...
                    if 'https://www.faceit.com/' in message.content and message.author in users_signing:
                        ...
                        await message.delete()
                        if message.author in users_signing: await message.channel.send("Not a valid faceit profile link, link should include 'https://www.faceit.com/'", delete_after=4)
                except Exception as e:
                    print(e)
                    await interaction.channel.send("**Signup timed out! deleting channel...**")
                    if self.signup_user in users_signing: del users_signing[self.signup_user]
